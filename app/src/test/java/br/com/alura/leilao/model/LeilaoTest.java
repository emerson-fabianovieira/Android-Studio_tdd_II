...
import br.com.alura.leilao.excepition.LanceMenorQueUltimoLanceException;
import br.com.alura.leilao.excepition.LanceSeguidoDoMesmoUsuarioException;
import br.com.alura.leilao.excepition.UsuarioJaDeuCincoLancesException;
...
//                tresMaioresLancesDevolvidos.get(2).getValor(), DELTA);
        ...
        //uma maneira de fazer com contains
...
//                new Lance(ALEX, 200.0)));
    ...
    public void naoDeve_AdicionarLance_QuandoForOMesmoDoUltimoLance() {
        CONSOLE.propoe(new Lance(ALEX, 500.0));
